#V1.0 : Untested Version- UART Only Interface, To Start on Boot 
#V1.2 UT: Untested Version, needs to be integrated with the working bare-bones version on the flight-pi's clone on the bench. 
#V1.3-> formatter_V1 -> FOXSI_TIMEPIX_formatter : Untested but merged with formatter_liteV1.2.py & formatter_tester.py in flight rpi 
#FOXSI_TIMEPIX_formatter.py V1.0 Tested Framework successfully Jan 17
#Test Me! Jan 21 (Full System) --- works on bench 
#Test Me! Jan 22 (ON Rocket)--- Works somewhat. Revisions added for WS
#Test Me:: Bench Pi 
#Test Me @White Sands! 
#UDP_Reader Updates::from rocket/2/13 
#3/16
# update rpi storage to never exceed 100% 
# updated more software error flags in code 
# updated packet functions:
# readrates, readallhk, update bytes9[all_flags])
...
GPIO.output(17,0)
#files 
hkfn = "/home/pi/uart_logs/hk.npz"
telefn = "/home/pi/uart_logs/telemetry.npz"
logfile = "/home/pi/uart_logs/foxsi_timepix_log.txt"
ws_path = '/home/pi/udp_logs'
